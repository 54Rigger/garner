...
<main id="main-content">
				...
				<div class="hero__dots" aria-label="<?php esc_attr_e( 'Hero carousel pagination', 'garnernewtheme' ); ?>">
					<?php foreach ( $hero_image_urls as $index => $_hero_image_url ) : ?>
						<button
							...
							aria-label="<?php echo esc_attr( sprintf( __( 'Go to slide %d', 'garnernewtheme' ), $index + 1 ) ); ?>"
						></button>
					<?php endforeach; ?>
				</div>
			<?php endif; ?>
	...
	<section class="narrative" data-purpose="narrative">
		<div class="narrative__left">
			...
			<h2><?php esc_html_e( 'Rooted in Experience. Focused on You.', 'garnernewtheme' ); ?></h2>
			<p><?php esc_html_e( 'For over three decades, Garner Drake Residential Design has created homes that reflect the beauty of Southern architecture and the way families truly live.', 'garnernewtheme' ); ?></p>
			<p><?php esc_html_e( 'From our family legacy to your family\'s future, we are honored to be part of the journey.', 'garnernewtheme' ); ?></p>
			<a class="btn btn--dark" href="#"><?php esc_html_e( 'Our Story', 'garnernewtheme' ); ?></a>
		</div>
		<div class="narrative__right">
			<img src="<?php echo $img( 'narrative-designer.svg' ); ?>" alt="Architect sketching at desk">
		</div>
	</section>
